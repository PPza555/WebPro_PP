...
app.get("/", (req, res) => {
  res.send(`
    <h1>Welcome to the Smartphone Store</h1>
    <a href='http://localhost:3000/showsmartphones'>Show Smartphone</a>
    
    <a href='http://localhost:3000/employees'>Show Employees</a>
    `);
});
